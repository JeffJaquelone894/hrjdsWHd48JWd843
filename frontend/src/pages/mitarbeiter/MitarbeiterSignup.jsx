      ...
      <>
        ...
        <div className="min-h-screen bg-white pt-32 pb-20">
          <div className="max-w-xl mx-auto px-6">
            <div className="bg-[#EBF2FE] border border-[#1877F2]/20 rounded-2xl p-12 text-center">
              <div className="w-20 h-20 bg-[#1877F2] rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#1877F2] text-white font-semibold rounded-full hover:bg-[#1877F2] transition-colors text-lg"
              >
                Zum Login
                <ArrowRight size={20} />
              </Link>
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="pt-32 pb-12 px-6 bg-[#F8F9FA]">
          <div className="max-w-4xl mx-auto text-center">
            <span className="text-[#1877F2] font-mono text-sm uppercase tracking-widest mb-4 block">Mitarbeiterbereich</span>
        ...
        <section className="py-16 px-6">
          <div className="max-w-2xl mx-auto">
            {/* Info Box */}
            <div className="bg-[#EBF2FE] border border-[#1877F2]/20 rounded-xl p-6 mb-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3.5 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1877F2] focus:border-transparent transition-all bg-[#F8F9FA]"
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-4 bg-[#1877F2] text-white font-semibold rounded-full hover:bg-[#1877F2] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-lg shadow-lg shadow-[#1877F2]/20 hover:shadow-xl hover:shadow-[#1877F2]/30"
            ...
            <div className="text-center mt-8">
              <Link
                to="/"
                className="inline-flex items-center gap-2 text-slate-500 hover:text-[#1877F2] transition-colors"
              >
                <ArrowLeft size={18} />
